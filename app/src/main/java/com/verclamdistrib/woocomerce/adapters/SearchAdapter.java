...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder>{
    ...
    SearchTermsAdapter filterTermsAdapter;

    SearchDialog filterDialog;


    public SearchAdapter(Context context, SearchDialog filterDialog) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        filterTermsAdapter = new SearchTermsAdapter(context, filterDialog, filterTermsList);
