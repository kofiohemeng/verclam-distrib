...
public class SearchTermsAdapter extends RecyclerView.Adapter<SearchTermsAdapter.MyViewHolder>{
    ...
    public SearchTermsAdapter(Context context, SearchDialog filterDialog, List<FilterTerm> filterTermsList) {
