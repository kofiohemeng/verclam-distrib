...
import com.verclamdistrib.woocomerce.activities.Login;
import com.verclamdistrib.woocomerce.activities.MainActivity;
import com.verclamdistrib.woocomerce.adapters.GroupedProductsAdapter;
import com.verclamdistrib.woocomerce.adapters.ProductAdapter;
import com.verclamdistrib.woocomerce.adapters.ProductAttributesAdapter;
import com.verclamdistrib.woocomerce.adapters.ProductReviewsAdapter;
import com.verclamdistrib.woocomerce.analytics.AppAnalytics;
...
import com.verclamdistrib.woocomerce.customs.DividerItemDecoration;
import com.verclamdistrib.woocomerce.databases.User_Favorites_DB;
import com.verclamdistrib.woocomerce.models.api_response_model.ErrorResponse;
import com.verclamdistrib.woocomerce.models.cart_model.CartDetails;
...
import com.verclamdistrib.woocomerce.models.product_model.ProductImages;
...
public class Product_Description extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    Button productCartBtn,store_btn,btnCheckOut;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnCheckOut = rootView.findViewById(R.id.check_out_btn);
        ...
        btnCheckOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MainActivity) getContext()).openCheckOut();
            }
        });
        return rootView;
    ...
    private void setProductDetails(final ProductDetails product) {
        ...
        if (productDetails!=null && !TextUtils.isEmpty(productDetails.getName())  && !TextUtils.isEmpty(productDetails.getCategoryNames())){
            AppAnalytics.addProductVisit(getActivity(),productDetails.getCategoryNames(),productDetails.getName());
        }
    ...
    public void showRateProductDialog() {
        ...
        dialog_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Name =  sharedPreferences.getString("userDisplayName", "");
